        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('bank.update', $bank->id)}}" method="post" autocomplete="off"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_bank"
                                           ...
                                           placeholder="BRI" value="{{old('nama_bank') ?? $bank->nama_bank}}">
                                    @error('nama_bank')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nomor_bank"
                                           ...
                                           id="nomor_bank" value="{{old('nomor_bank') ?? $bank->nomor_bank}}"
