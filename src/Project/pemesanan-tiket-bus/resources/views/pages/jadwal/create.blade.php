                            ...
                            <form action="{{ route('jadwal.store') }}" method="post" autocomplete="off">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="bus" id="bus"
                                        class="form-select @error('bus') is-invalid @enderror bus">
                                        <option value="">Pilih Bus</option>
                                        @foreach ($buses as $bus)
                                            <option value="{{ $bus->id }}" @selected(old('bus'))>
                                                {{ $bus->nama }}</option>
                                        @endforeach
                                    </select>
                                    @error('bus')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="kota_asal" id="kota_asal"
                                        ...
                                        @foreach ($regencies as $regency)
                                            <option value="{{ $regency->id }}" @selected(old('kota_asal'))>
                                                {{ $regency->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('kota_asal')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="terminal_kota_asal" class="text form-control @error('terminal_kota_asal') is-invalid @enderror"
                                        id="terminal_kota_asal" placeholder="Terminal Bus A">{{ old('terminal_kota_asal') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="kota_tujuan" id="kota_tujuan"
                                        ...
                                        @foreach ($regencies as $regency)
                                            <option value="{{ $regency->id }}" @selected(old('kota_tujuan'))>
                                                {{ $regency->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('kota_tujuan')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="terminal_kota_tujuan" class="text form-control @error('terminal_kota_tujuan') is-invalid @enderror"
                                        id="terminal_kota_tujuan" placeholder="Terminal Bus B">{{ old('terminal_kota_tujuan') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="kedatangan"
                                        ...
                                        id="kedatangan" placeholder="20" value="{{ old('kedatangan') }}">
                                    @error('kedatangan')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="keberangkatan"
                                        ...
                                        id="keberangkatan" placeholder="20" value="{{ old('keberangkatan') }}">
                                    @error('keberangkatan')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="tarif"
                                        ...
                                        placeholder="30000" value="{{ old('tarif') }}">
                                    @error('tarif')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
