                            ...
                            <form action="{{route('jadwal.update', $jadwal->id)}}" method="post" autocomplete="off">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="bus" id="bus"
                                        ...
                                        @foreach($buses as $bus)
                                            <option
                                                value="{{$bus->id}}" @selected(old('bus') ?? $bus->id == $jadwal->bus_id ? 'selected' : '')>{{$bus->nama}}</option>
                                        @endforeach
                                    </select>
                                    @error('bus')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="kota_asal" id="kota_asal"
                                        ...
                                        @foreach($regencies as $regency)
                                            <option
                                                value="{{$regency->id}}" @selected(old('kota_asal') ?? $regency->id == $jadwal->kota_asal ? 'selected' : '')>{{$regency->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('kota_asal')
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="terminal_kota_asal"
                                              ...
                                              placeholder="Terminal Bus A">{{old('terminal_kota_asal') ?? $jadwal->terminal_kota_asal}}</textarea>
                                    ...
                                    <select name="kota_tujuan" id="kota_tujuan"
                                        ...
                                        @foreach($regencies as $regency)
                                            <option {{$regency->id == $jadwal->kota_tujuan ? 'selected' : ''}}
                                                    value="{{$regency->id}}" @selected(old('kota_tujuan') ??  $regency->id == $jadwal->kota_tujuan ? 'selected' : '')>{{$regency->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('kota_tujuan')
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="terminal_kota_tujuan"
                                              ...
                                              placeholder="Terminal Bus B">{{old('terminal_kota_tujuan') ?? $jadwal->terminal_kota_tujuan}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="kedatangan"
                                           ...
                                           id="kedatangan"
                                           placeholder="20" value="{{old('kedatangan') ?? $jadwal->kedatangan}}">
                                    @error('kedatangan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="keberangkatan"
                                           ...
                                           id="keberangkatan"
                                           placeholder="20" value="{{old('keberangkatan') ?? $jadwal->keberangkatan}}">
                                    @error('keberangkatan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="tarif"
                                           class="text form-control @error('tarif') is-invalid @enderror"
                                           id="tarif"
