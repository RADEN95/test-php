                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{ route('home') }}" class="text-decoration-none fw-medium text-secondary">Home</a>
                        </li>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card shadow border-0 overflow-hidden">
                        <img src="{{ asset('storage/' . $booking->bus->gambar) }}" class="card-img rounded-bottom-0"
                            alt="">
                        <div class="card-body">
                            <h4 class="text-primary fw-bold">{{ $booking->bus->nama }}</h4>
                            <div>
                                <div>
                                    {{ $booking->asal->name }} - {{ $booking->tujuan->name }} |
                                    <span class="text-success fw-bold">{{ currencyIndo($booking->tarif) }}</span>
                                </div>
                                <div>
                                    <p>Tanggal Berangkat <span
                                            class="text-primary fw-medium">{{ tanggalWaktu($booking->keberangkatan) }}
                                            WIB</span>
                                    </p>
                                </div>
                            </div>
                    ...
                    <form action="{{ route('booking.store') }}" method="post" autocomplete="off">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="nama"
                                ...
                                aria-label="Nama" value="{{ old('nama') ?? auth()->user()->name }}"
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="email" name="email"
                                ...
                                aria-label="Email" value="{{ old('email') ?? auth()->user()->email }}" readonly
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="diskon"
                                ...
                                aria-label="Promo" value="{{ old('diskon') }}" aria-describedby="basic-addon3">
                            @error('diskon')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
